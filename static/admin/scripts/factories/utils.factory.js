(function() {
    ...
    function UtilsFactory(CONST, $http, NotificationFactory, SweetAlertFactory, notify, NgTableParams)
    {
        var mmstreetUtilities = {
            ...
            mmstreetTableOptions : function (dataset) {
                var per_page = 10;
            ...
            mmstreetGroupTableOptions : function (dataset, group) {
                var per_page = 10;
            ...
            serverPagination: function(url,attr){
                ...
                return new NgTableParams({
                    ...
                    getData: function($defer, params) {
                        ...
                        $http.post(CONST.CONFIG.BASE_URL + url, param)
                            .success(function(response) {
                                params.total(response.result.total);
                                $defer.resolve(response.result.mmstreetData);
                            });
                    }
                })
            },
        ...
        return mmstreetUtilities;
    }

    //Inject required modules to factory method
    NotificationFactory.$inject = ['CONST', 'toaster', '$http','ngNotify'];
     ...
     * @constructor
     */
    function NotificationFactory(CONST, toaster, $http,ngNotify)
    {
        var mmstreetNotification = {
                /**
             * @name showMessage
...
function SweetAlertFactory($timeout, $window) {
    ...
    /**
     * Associate factory with mmstreet module
     */
    angular
        .module('mmstreet')
